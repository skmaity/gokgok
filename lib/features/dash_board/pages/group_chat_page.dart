...
import 'package:gokgok/features/dash_board/providers/chat_provider.dart';
...
class _GroupChatPageState extends ConsumerState<GroupChatPage> {
  ...
  Future<void> _send() async {
    ...
    await ref.read(chatServiceProvider).sendMessage(_conversationId!, text);
    _scrollToBottom();
  }
      ...
      data: (messages) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, i) {
            ...
            return _MessageBubble(message: msg, isMe: isMe, highlight: highlight);
          },
        );
      },
    );
